    ...
    if (project.featured) {
        return (
            <div className="col mb-4">
                <div className='card project-card shadow h-100' style={{minHeight: "300px"}}>
                        <div className='row h-100'>
                            <div className='col-md-7' >
                                <img src={project.pic} alt="project thumbnail" style={{maxWidth: "100%", height: "100%", objectFit: "cover"}}/>
                            </div>
                            <div className='col-md-5 my-auto'>
                                <div className='p-3'>
                                    <h2 style={{fontWeight: "bold", color: "black"}}>{project.title}</h2>
                                    <p className="text-muted">{project.description}</p>

                                </div>
                                {project.awards ? (
                                <p class="card-text text-muted mb-4" style={{fontStyle: "italic"}}>Awards: {project.awards}</p>
                            ) : (
                                null
                            )}
                ...
                <div class="card shadow my-3">
                    ...
                    <div class="card-body bg-light">
                        <div style={{minHeight: "190px"}}>
                            ...
                            {project.awards ? (
                                <p class="card-text mb-4 text-muted" style={{fontStyle: "italic"}}>Awards: {project.awards}</p>
                            ) : (
                                null
                            )}
                        </div>
