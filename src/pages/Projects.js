...
export default function Projects() {
    const projects = [
        ...
        },
        {
            title: "Browser Party",
            description:
                "Browser Party is fully browser-based multiplayer party game that allows users to compete and chat with each other in real time using socket.io and React. This project was an absolute joy to make and I look forward to making more accessible games in the future.",
